        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LevelOrRank = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Archetype = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TCGDate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OCGDate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PendulumDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedDeck = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeckInfo", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeckCard_CardsInfo_CardId",
                        column: x => x.CardId,
                        principalTable: "CardsInfo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeckCard_DeckInfo_DeckId",
                        column: x => x.DeckId,
                        principalTable: "DeckInfo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserDecks_DeckInfo_DeckId",
                        column: x => x.DeckId,
                        principalTable: "DeckInfo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
